<template>
  <div class="px-6 md:px-12 py-16 bg-[#0A0A0B] min-h-[calc(100vh-56px)] text-white font-sans relative overflow-hidden">
    ...
    <div class="max-w-5xl mx-auto relative z-10">
      <!-- Header Section -->
      <div class="mb-20">
        <h1 class="text-4xl font-semibold tracking-[-0.04em] text-white">Knowledge Base</h1>
        <p class="mt-4 text-[#A1A1AA] text-[15px] leading-relaxed max-w-xl font-medium">
          Upload documents and data so your AI assistants can answer customer questions accurately. The more you train them, the smarter they get.
        </p>
      </div>
